...
public class Assessment extends AppCompatActivity {
    ...
    List<Quetion_Model_List> rowListItem;    private JSONArray result;    public static final String JSON_ARRAY = "result";    ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();    SharedPreferences sharedPreferences;    SharedPreferences.Editor editor;    EditText edit_fill_answer;    public TextView txt_quetion;    RadioGroup radiogrp;    RadioButton radio1, radio2, radio3, radio4;    TextView txt_timer;    LinearLayout empty_view;    String student_id, exam_id, exam_title, exam_duration;    Button btn_Previous, btn_Next, btn_submit;    int i = 0;    String realaAns, student_retake;    ProgressDialog progressDialog;    private boolean isCanceled = false;    AppCompatCheckBox check_invalid;    int count;    ImageView image_quetion, image_op1, image_op2, image_op3, image_op4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assessment);        StrictMode.ThreadPolicy policy = new          StrictMode.ThreadPolicy.Builder().permitAll().build();        StrictMode.setThreadPolicy(policy);

        sharedPreferences = getApplicationContext().getSharedPreferences("Mydata", MODE_PRIVATE);        sharedPreferences.edit();                String student_class = sharedPreferences.getString("student_class", null);        student_id = sharedPreferences.getString("idtag", null);        exam_id = sharedPreferences.getString("exam_id", null);        exam_title = sharedPreferences.getString("exam_title", null);        String exam_type = sharedPreferences.getString("exam_type", null);        String exam_fee = sharedPreferences.getString("exam_fee", null);        String exam_deadline = sharedPreferences.getString("exam_deadline", null);        String exam_department = sharedPreferences.getString("exam_department", null);        String exam_class = sharedPreferences.getString("exam_class", null);        exam_duration = sharedPreferences.getString("exam_duration", null);        String exam_subject = sharedPreferences.getString("exam_subject", null);        String exam_passmark = sharedPreferences.getString("exam_passmark", null);        String exam_retake = sharedPreferences.getString("exam_retake", null);        String exam_status = sharedPreferences.getString("exam_status", null);        String next_retake = sharedPreferences.getString("next_retake", null);        String quetions = sharedPreferences.getString("quetions", null);        String exam_attended = sharedPreferences.getString("exam_attended", null);        student_retake = sharedPreferences.getString("student_retake", null);        String exam_allowed = sharedPreferences.getString("exam_allowed", null);        String next_retake_b = sharedPreferences.getString("next_retake_b", null);        initToolbar();        deleteCache(Assessment.this);       showDialog();        txt_quetion = (TextView) findViewById(R.id.txt_quetion);        radiogrp = (RadioGroup) findViewById(R.id.radiogrp);        radio1 = (RadioButton) findViewById(R.id.radio1);        radio2 = (RadioButton) findViewById(R.id.radio2);        radio3 = (RadioButton) findViewById(R.id.radio3);        radio4 = (RadioButton) findViewById(R.id.radio4);        edit_fill_answer = (EditText) findViewById(R.id.edit_fill_answer);        image_quetion = (ImageView) findViewById(R.id.image_quetion);        image_op1 = (ImageView) findViewById(R.id.image_op1);        image_op2 = (ImageView) findViewById(R.id.image_op2);        image_op3 = (ImageView) findViewById(R.id.image_op3);        image_op4 = (ImageView) findViewById(R.id.image_op4);        btn_submit = (Button) findViewById(R.id.btn_submit);        btn_Previous = (Button) findViewById(R.id.btn_Previous);        btn_Next = (Button) findViewById(R.id.btn_Next);        txt_timer = (TextView) findViewById(R.id.txt_timer);        int minutes = Integer.parseInt(exam_duration);        check_invalid = (AppCompatCheckBox) findViewById(R.id.check_invalid);
        ...
        btn_Previous.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (rowListItem.get(i).getOp1().equals("-") && rowListItem.get(i).getOp1().equals("-")) {
                    ...
                    Log.i("sadgfbsAfasa", rowListItem.get(i).getOp4());
    ...
    private void getCategory(JSONArray j) {
        for (int i = 0; i < j.length(); i++) {
            try {
                ...
                Log.i("zfsdas", json.getString("op1") + json.getString("op2") + json.getString("op3") + json.getString("op4"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
    ...
    public void onBackPressed() {
        ...
        // startActivity(i);
        // finish();
        Dialog dialog = new Dialog(Assessment.this, android.R.style.Theme_Material_Light_Dialog);
        ...
        dialog.findViewById(R.id.button5).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(Assessment.this, MainActivity3.class);
                startActivity(i);
                finish();
            }
        });
